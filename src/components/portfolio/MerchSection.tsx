...
const MerchSection = () => {
  return (
    <section id="merch" className="section-merch py-8 sm:py-20 lg:py-24 px-4 sm:px-6 relative z-10">
      <div className="container mx-auto">
        <div className="text-center mb-6 sm:mb-16">
          <h2 className="text-4xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-8 px-2 sm:px-0">
            <span className="text-gradient">Merch</span>
          </h2>
        </div>

        <div className="max-w-4xl mx-auto px-4 sm:px-0">
          <div className="modern-card rounded-xl sm:rounded-2xl p-4 sm:p-12 lg:p-16 text-center">
